...
class SupportController extends Controller
{
    public function indexUser()
    {
        ...
        $data = SupportModel::where('code_user',$code )->orderByDesc('created_at')->get();
    ...
    {
        $status_service = config('common.status_support');
        ...
        return view('page.auth.support.list',compact('data', 'status_service'));
    }
