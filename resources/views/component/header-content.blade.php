        ...
        <div class="header-body px-3 px-xxl-5 py-3 py-lg-4">
            <div class="row align-items-center">
                <a href="javascript:void(0);" class="muze-hamburger d-block d-lg-none col-auto">
                    ...
                    <img src="https://fabrx.co/preview/muse-dashboard/assets/svg/icons/close1.svg" style="width: 20px;" class="menu-close" alt="img" />
                </a>
                <a class="navbar-brand mx-auto d-lg-none col-auto px-0" href="#">
                    <img src="https://fabrx.co/preview/muse-dashboard/assets/svg/brand/logo.svg" alt="Muze" />
                    <img src="https://fabrx.co/preview/muse-dashboard/assets/svg/brand/logo-white.svg" alt="Muze" class="white-logo" />
                </a>
                            ...
                            <ul class="navbar-nav" id="accordionExample2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link collapsed" href="#sidebarApps2" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps2">
                                        ...
                                        &nbsp;<span class="ms-2 position-relative">Apps <sup class="status bg-warning position-absolute">&nbsp;</sup></span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="https://fabrx.co/preview/muse-dashboard/documentation/index.html" target="_blank">
                                        <svg data-name="Icons/Tabler/Paperclip" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                        ...
                                        &nbsp;<span class="ms-2">Docs</span> <span class="docs-version">v1.0</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-auto d-flex flex-wrap align-items-center icon-blue-hover ps-0">
                    <button class="btn btn-soft-secondary">Số dư : {{auth()->user()->point}} vnd</button>
                    <div class="dropdown grid-option">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="notification">
                                            ...
                                            <div class="media">
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white">
                                                                    <img src="../assets/img/avatar-sm3.png" alt="Facebook" /><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                                                                </span>
                                                            </span>
                                        ...
                                        <a href="#" class="dropdown-item text-wrap unread">
                                            <div class="media">
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white">
                                                                    <img src="../assets/img/avatar-sm4.png" alt="Facebook" /><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                                                                </span>
                                                            </span>
                                                <div class="media-body ps-1">
                                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="#" class="dropdown-item text-wrap">
                                            <div class="media">
                                                            <span class="d-flex align-items-center">
                                                                <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                                                                <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white">
                                                                    <img src="../assets/img/avatar-sm5.png" alt="Facebook" /><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                                                                </span>
                                                            </span>
                                                <div class="media-body ps-1">
                                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="#" class="dropdown-item text-wrap">
                                            <div class="media">
                                                            <span class="d-flex align-items-center">
                                                                <span class="avatar-status avatar-sm-status avatar-offline position-relative me-2 end-0 bottom-0">&nbsp;</span>
                                                                <span class="avatar avatar-xs shadow-sm rounded-circle me-2 d-flex align-items-center justify-content-center bg-white">
                                                                    <img src="../assets/img/avatar-sm6.png" alt="Facebook" /><span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                                                                </span>
                                                            </span>
                                                <div class="media-body ps-1">
                                                    <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown-footer text-center py-2 border-top border-gray-50">
                                <a href="#" class="btn btn-link link-dark my-2">
                                    View all
                                    <svg class="ms-2" data-name="Icons/Tabler/Chevron Down" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                    ...
                    <div class="dropdown profile-dropdown">
                        <a href="#" class="avatar avatar-sm avatar-circle ms-4 ms-xxl-5" data-bs-toggle="dropdown" aria-expanded="false" id="dropdownMenuButton">
                            <img class="avatar-img" src="https://i.pinimg.com/736x/8b/16/7a/8b167af653c2399dd93b952a48740620.jpg" alt="Avatar" />
                            <span class="avatar-status avatar-sm-status avatar-success">&nbsp;</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            <li class="pt-2 px-4">
                                <span class="fs-16 font-weight-bold text-black-600 Montserrat-font me-2">{{auth()->user() ? auth()->user()->name : ""}}</span><img src="https://fabrx.co/preview/muse-dashboard/assets/svg/icons/fill-check.svg" alt="icon" />
                                <small class="text-gray-600 pb-3 d-block"><a href="https://fabrx.co/cdn-cgi/l/email-protection" class="__cf_email__" >{{auth()->user() ? auth()->user()->email : ""}}</a></small>
                                <small class="text-gray-600 pb-3 d-block"><a href="https://fabrx.co/cdn-cgi/l/email-protection" class="__cf_email__" >{{auth()->user()->point}} Xu</a></small>
                            </li>
                            <li class="dropdown">
                                <a class="dropdown-item" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="Status" href="#">
                                    <svg data-name="Icons/Tabler/Share" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    ...
                                    <span class="ms-2">Status</span><img src="https://fabrx.co/preview/muse-dashboard/assets/svg/icons/right-arrow@10.svg" alt="Right Arrow" class="ms-auto" />
                                </a>

                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="Status">
                                    <li>
                                        <a class="dropdown-item" href="#"><span class="status online"></span><span class="ms-2">Available</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#"><span class="status dnd"></span><span class="ms-2">Busy</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#"><span class="status away"></span><span class="ms-2">Away</span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#"><span class="status offline"></span><span class="ms-2">Offline</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-sm flex-column" id="submenu6">
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse collapse-box" id="AccountPage4" data-bs-parent="#submenu6">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="settings.html" class="nav-link">Face</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="billing.html" class="nav-link active">Billing</a>
                                                </li>
