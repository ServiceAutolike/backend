                                    ...
                                    @foreach($data as $item)
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <!--begin::Title-->
                                                <a href="../../demo8/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-bold">{{$item->subject}}</a>
                                                <!--end::Title-->
                                                <!--begin::Label-->
                                                <span class="badge badge-light my-1">{{$item->service}}</span>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Content-->
                                            <!--begin::Text-->
                                            ...
                                            <a href="/support_chat/{{$item->code_chat}}">Chat</a>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Section-->
                                    </div>
                            ...
                            <form id="kt_modal_new_ticket_form" class="form" action="#">
                                ...
                                <div class="row g-9 mb-8">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Chọn một dịch vụ" name="product">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                            <span class="required">id bai viet(neu co)</span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a subject for your issue"></i>
                                        </label>
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid" placeholder="Enter your ticket subject" name="subject" />
