                        ...
                        <div class="card-toolbar">
                            <ul class="nav nav-stretch nav-line-tabs border-transparent" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a id="kt_billing_list_tab" class="nav-link fs-5 fw-bolder me-5 active"
                                       data-bs-toggle="tab" role="tab" href="#list" aria-selected="true">Danh sách</a>
                                </li>
                                <!--end::Tab item-->
                                <!--begin::Tab item-->
                                <li class="nav-item" role="presentation">
                                    <a id="kt_billing_create_tab" class="nav-link fs-5 fw-bolder" data-bs-toggle="tab"
                                       role="tab" href="#create" aria-selected="false">Tạo hỗ trợ mới</a>
                                </li>
                                <!--end::Tab item-->
                            </ul>
                        </div>
                                ...
                                <div v-else class="d-flex flex-column flex-xl-row p-7">
                                    ...
                                    <div class="flex-lg-row-fluid mb-20 mb-xl-0">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="mb-5">
                                                <!--begin::Ticket-->
                                                <div class="mb-5 form-control form-control-solid" v-for="item in data" :key="item.id">
