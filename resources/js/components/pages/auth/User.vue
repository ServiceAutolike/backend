                    ...
                    <div v-else class="table-responsive">
                        ...
                        <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
                            ...
                            <tr v-for="data in dataAll" :key="data.id">
                                ...
                                <td>
                                    <router-link :to="{ path: '/admin/user/change/'+ data.id}" class="btn btn-danger btn-hover-scale me-5 btn-sm">
                                        Thay đổi
                                    </router-link>
                                    <button class="btn btn-dark btn-hover-scale me-5 btn-sm" @click="loginUser(data.id)">
                                        Đăng nhập
                                    </button>
                                </td>
                            </tr>
