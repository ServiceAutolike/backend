                    ...
                    <div class="tab-pane fade" :class="{ 'active show': isActive('create') }" id="create">
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <label>Nội dung | Max <span class="badge badge-success">{{ total_description }}/{{ number_seeding }}</span></label>
                                    <el-input v-model="description" :rows="5" placeholder="Nhập comment, mỗi dòng được tính là 1 nội dung" type="textarea" @input="calDesc"></el-input>
                                </div>
