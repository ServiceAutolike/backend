                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <label for="user_id">Nhập ID hoặc URL group <span
                                    ...
                                    <div v-bind:class="{'spinner spinner-success spinner-right': loading_input}">
                                        <input type="text" v-bind:class="[activeClass, errorClass]" class="form-control"
                                               id="user_id" v-model="post_id" placeholder="Nhập URL hoặc ID group của bạn"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="sitePrice">Giá/1 member (VNĐ) <span
                                                class="text-danger">*</span></label>
                                ...
                                <div
                                    ...
                                    <div class="fw-bold">
                                        ...
                                        <div>Bạn sẽ thêm <strong
                                            class="text-danger">{{ Number(number_seeding).toLocaleString() }} member</strong> vào nhóm với giá <strong class="text-danger">{{ sitePrice }}<sup>đ</sup>/1</strong>
                                            <strong class="text-danger">member</strong> tốc độ <b class="text-success">{{ speed }}</b></div>
                                    </div>
                                </div>
                            </form>
                        </div>
