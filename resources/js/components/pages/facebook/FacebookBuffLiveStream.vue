                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <label for="user_id">Nhập URL live stream <span
                                    ...
                                    <div v-bind:class="{'spinner spinner-success spinner-right': loading_input}">
                                        <input type="text" v-bind:class="[activeClass, errorClass]" class="form-control"
                                               id="user_id" v-model="post_id" placeholder="Nhập URL live stream"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="sitePrice">Giá/1 mắt (VNĐ) <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="sitePrice">Thời gian duy trì <span
                                                class="text-danger">*</span>
                                            </label>
                                            <el-select v-model="timeLivestream" placeholder="Chọn tốc độ" style="display: block" @change="changeTotal">
                                                <el-option
                                            ...
                                            <p class="mt-2"><i class="text-danger"><small>Tổng tiền = (Số lượng mắt) x (Số phút) x (Giá tiền mỗi mắt)</small></i></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="fw-bold">
                                        ...
                                        <div>Bạn sẽ mua <strong
                                            class="text-danger">{{ Number(number_seeding).toLocaleString() }} mắt</strong> với giá <strong class="text-danger">{{ sitePrice }}<sup>đ</sup>/1</strong>
                                            <strong class="text-danger">mắt</strong> thời gian <b class="text-success">{{ timeLivestream }} phút</b></div>
                                    </div>
                                </div>
                            </form>
                        </div>
...
export default {
    ...
    methods: {
        ...
        calDesc() {
            this.arrDesc = this.description.split('\n')
            this.total_description = this.arrDesc.length
        },
        setActive(menuItem) {
            if(menuItem == "history") {
                this.isTable = true
        ...
        isValidate() {
            ...
            else if(this.timeLivestream == null) {
                return false
            }
